...
const SPLINE_SCENE_URL = "https://prod.spline.design/wqMglzhYP3L6Uy-p/scene.splinecode";

interface SplineDemo2Props {
  plain?: boolean;
  heightClassName?: string;
}

export function SplineDemo2({ plain = false, heightClassName = "h-[430px]" }: SplineDemo2Props) {
  if (plain) {
    return (
