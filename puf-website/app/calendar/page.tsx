                  ...
                  {daysArray.map((day, idx) => {
                    ...
                    return (
                      <button
                        ...
                        className={`relative rounded-lg p-2 text-sm font-semibold transition-all ${day
                            ? dayIsToday
                        ...
                        {dayTasks.length > 0 && (
                          <div className="absolute bottom-1 right-1 flex gap-1">
                            {dayTasks.slice(0, 2).map((task, i) => (
                              <div
                                key={i}
                                className={`h-1.5 w-1.5 rounded-full ${task.source === "ai"
                                    ? "bg-purple-400"
                        ...
                        >
                          <div className="flex items-start gap-2 flex-1">
                            ...
                            <div className="flex-1">
                              <p
                                className={`text-sm font-semibold ${task.status === "done" ? "line-through opacity-60" : ""
                                  }`}
                              >
                                {task.title}
                              </p>
